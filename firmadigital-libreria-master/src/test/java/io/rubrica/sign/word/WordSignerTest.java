...
public class WordSignerTest {
    ...
    public void testSignWord() throws Exception {
        ...
        File tempFile2 = File.createTempFile("word", "." + "test2.docx");
        ...
        byte[] archivoWord = readFileToByteArray(TestManejadorDocumento.obtenerArchivo("prueba.docx"));
