...
public class TestFirma {
	...
	public void deberiaDevolveListaItems() throws Exception {
		DTOParametroFirma dtoParametroFirma = new DTOParametroFirma();
		...
		dtoParametroFirma.setCertficado(servicioFirma.encode(certificado));
		dtoParametroFirma.setDocumento(servicioFirma.encode(archivoWord));
		dtoParametroFirma.setPassowrd(clave);
		@SuppressWarnings("unchecked")
		String firmado = restTemplate.postForObject(String.format("http://localhost:%s/servicio-firma/firmar/word", port),
